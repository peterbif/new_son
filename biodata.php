                                    ...
                                    <div class="panel panel-danger">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <form class="form-horizontal"  method="post" autocomplete="off" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" enctype="multipart/form-data">
                                                       <h3 class="text-center"> <?php   if($program_cut != ""){echo'<a href="academic_calendar.pdf" target="_blank"><span style="color: orangered">2022/2023 Academic Calendar</span></a>';}?></h3>
